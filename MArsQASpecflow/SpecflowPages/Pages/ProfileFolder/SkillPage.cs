...
namespace MArsQASpecflow.SpecflowPages.Pages
{
    class SkillPage
    {
        ...
        public IWebElement Skills => Driver.driver.FindElement(By.XPath("//input[@name ='name']"));
        ...
        public void AddSkill()
        {
            ...
            ExceLibHelper.PopulateInCollection(ConstantHelpers.ExcelPath, "ProfileSkills");
            //click on Skill
            Thread.Sleep(3000);
        ...
        { 
            ...
            try
            {
                ...
                String expectedValue = ExceLibHelper.ReadData(2, "Skill");
                //Get the table list
        ...
        public void UpdateSkill()
        {
            ...
            for (int i = 1; i <= rowCount; i++)
            {
                ...
                if (actualValue.Equals(expectedValue))
                {
                    ...
                    //Clear Previous text 
                    editRowValue.Clear();
                    editRowValue.SendKeys(ExceLibHelper.ReadData(i + 1, "UpdatedSkill"));
        ...
        public void ValidateUpdateSkill()
        {
            ...
            try
            {
                ...
                String expectedValue1 = ExceLibHelper.ReadData(2, "UpdatedSkill");
                //Get the table list
        ...
        public void DeleteSkill()
        {
            ...
            // Populate Login page test data collection
            ExceLibHelper.PopulateInCollection(ConstantHelpers.ExcelPath, "ProfileSkills");
            String expectedValue = ExceLibHelper.ReadData(2, "DeleteSkill");
        ...
        public void ValidateDelSkill()
        {
            ...
            try
            {
                ...
                String expectedValue1 = ExceLibHelper.ReadData(2, "DeleteSkill");
                //Get the table list
